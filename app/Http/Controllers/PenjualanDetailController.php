...
class PenjualanDetailController extends Controller
{
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            $row = array();
            $row['kode_produk'] = '<span >'. $item->produk['kode_produk'] .'</span';
            ...
            $row['aksi']        = '<div class="btn-group">
                                    <button onclick="deleteData(`'. route('transaksi.destroy', $item->id_penjualan_detail) .'`)" class="btn  btn-danger"><i class="fa fa-trash"></i></button>
                                </div>';
            $data[] = $row;
