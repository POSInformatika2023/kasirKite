            ...
            $.get('<?php echo e(route('setting.show')); ?>')
                .done(response => {
                    ...
                    $('.tampil-kartu-member').html(
                        `<img src="<?php echo e(url('/')); ?>${response.path_kartu_member}" width="300">`);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tutorial-membuat-aplikasi-point-of-sales-main\resources\views/setting/index.blade.php ENDPATH**/ ?>