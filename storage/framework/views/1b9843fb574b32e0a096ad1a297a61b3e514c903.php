        ...
        <div class="col-lg-12">
            <div class="box">
                        ...
                        <div class="col-lg-4">
                            <form action="<?php echo e(route('transaksi.simpan')); ?>" class="form-penjualan" method="post">
                                ...
                                <input type="hidden" name="id_member" id="id_member"
                                    value="<?php echo e($memberSelected->id_member); ?>">
                                ...
                                <div class="form-group row">
                                    <label for="diskon" class="col-lg-2 control-label hidden">Diskon</label>
                                    <div class="col-lg-8">
                                        <input type="number" name="diskon" id="diskon" class="form-control hidden"
                                            value="<?php echo e(!empty($memberSelected->id_member) ? $diskon : 0); ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" id="diterima" class="form-control" name="diterima"
                                            value="<?php echo e($penjualan->diterima ?? 0); ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary pull-right btn-simpan"><i class="fa fa-floppy-o"></i>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kasirkite\resources\views/penjualan_detail/index.blade.php ENDPATH**/ ?>