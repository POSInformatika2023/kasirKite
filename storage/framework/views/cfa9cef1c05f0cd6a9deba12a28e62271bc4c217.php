...
<head>
    ...
    <title>KasirKite | <?php echo $__env->yieldContent('title'); ?></title>
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

    <link rel="icon" href="<?php echo e(url('/')); ?>/img/POS2.png" type="image/png">
...
<body class="hold-transition skin-blue-light sidebar-mini">
    <div class="wrapper">
        ...
        <?php if ($__env->exists('layouts.custom_side')) echo $__env->make('layouts.custom_side', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\kasirkite\resources\views/layouts/kasir.blade.php ENDPATH**/ ?>